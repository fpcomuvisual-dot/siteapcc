...
export default function SobreContent({ volunteers }: { volunteers: Volunteer[] }) {
    return (
                ...
                <section>
                    ...
                    >
                        {volunteers.map((vol, index) => (
                            <motion.div key={vol.id || index} variants={fadeInUp} whileHover={{ y: -5 }}>
                                <Card className="overflow-hidden border-border bg-card shadow-sm hover:shadow-xl hover:shadow-primary/10 transition-all text-center h-full">
                                    ...
                                    <CardContent className="p-4">
                                        <h3 className="font-bold text-foreground text-sm md:text-base">{vol.nome}</h3>
