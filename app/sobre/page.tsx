...
const volunteers = [
    { name: "Ana Luiza Henrique da Silva", img: "/voluntarios/ana-luiza-henrique-da-silva.png" },
    { name: "Aparecida de Jesus Tomazini Pelegrini", img: "/voluntarios/aparecida-de-jesus-tomazini-pelegrini.png" },
    { name: "Eliane Cardozo Salum", img: "/voluntarios/eliane-cardozo-salum.png" },
    { name: "Fatima AP. Moreira Lacerda", img: "/voluntarios/fatima-ap-moreira-lacerda.png" },
    { name: "Fernanda Santos Hipólito Ferreira", img: "/voluntarios/fernanda-santos-hipolito-ferreira.png" },
    { name: "Francelina Gonçalves Matheus", role: "Fundadora", img: "/voluntarios/francelina-goncalves-matheus.png" },
    { name: "Magali Pangoni Soares", img: "/voluntarios/magali-pangoni-soares.png" },
    { name: "Mara Rosana Peralta Romeiro", img: "/voluntarios/mara-rosana-peralta-romeiro.png" },
    { name: "Maria Antônia Aliotti de Lima", img: "/voluntarios/maria-antonia-aliotti-de-lima.png" },
    { name: "Maria Carolina Casanova", img: "/voluntarios/maria-carolina-casanova.png" },
    { name: "Maria Cuerin Parisotto", img: "/voluntarios/maria-cuerin-parisotto.png" },
    { name: "Maria de Lourdes Santos Bertolla", img: "/voluntarios/maria-de-lourdes-santos-bertolla.png" },
    { name: "Maria Regina Plaza", img: "/voluntarios/maria-regina-plaza.png" },
    { name: "Marlei Regina da Luz Durães", img: "/voluntarios/marlei-regina-da-luz-duraes.png" },
    { name: "Márcia Regina Deperon", role: "Atual Presidente", img: "/voluntarios/marcia-regina-deperon.png" },
    { name: "Matilde Ribeiro de Melo", img: "/voluntarios/matilde-ribeiro-de-melo.png" },
    { name: "Oclesia Maria Maróstica Hortal", img: "/voluntarios/oclesia-maria-marostica-hortal.png" },
    { name: "Sander Figueiredo Salum", img: "/voluntarios/sander-figueiredo-salum.png" },
    { name: "Silvia Affini Jorge", img: "/voluntarios/silvia-affini-jorge.png" },
    { name: "Silvia Barbosa de Sá Pinheiro", img: "/voluntarios/silvia-barbosa-de-sa-pinheiro.png" },
];
